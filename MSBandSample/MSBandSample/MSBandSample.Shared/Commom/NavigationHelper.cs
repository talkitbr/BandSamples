namespace MSBandSample.Commom
{
    ...
    /// <summary>
    /// Navigation helper cllas
    /// </summary>
    [Windows.Foundation.Metadata.WebHostHidden]
    [SuppressMessage("Microsoft.StyleCop.CSharp.DocumentationRules", "*", Justification = "Reviewed.")]
    public class NavigationHelper : DependencyObject
    {
        /// <summary>
        /// Gets or sets Page property
        /// </summary>
        private Page Page
        {
            get;
